...
public static class ProfileErrors
{
    ...
    public static readonly ApiError InsufficientCredits = new("profile/insufficient-credits", "Insufficient balance please contact 0104 455 6061", StatusCodes.Status400BadRequest);
